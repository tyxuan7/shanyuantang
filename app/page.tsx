    ...
    <div className="mx-auto max-w-6xl px-4 pb-20">
      ...
      <section className="pb-16">
        <div className="rounded-t-xl rounded-b-xl border-x-4 border-gold/40 bg-paper-warm px-8 py-6 text-ink shadow-card space-y-4 text-center"
          ...
          <Link href="/temple"
            className="inline-flex items-center justify-center gap-2 font-body font-medium transition-all rounded-lg bg-red-700 tracking-wider text-white shadow-lg shadow-red-600/30 hover:bg-red-600 h-10 px-5 text-base no-underline">
            敬上一炷清香
          </Link>
          <GoldDivider/>
        </div>
